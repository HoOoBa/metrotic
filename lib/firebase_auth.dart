...
*/
  ...
  CollectionReference usersReference =
      FirebaseFirestore.instance.collection('Users'.tr());
  CollectionReference ticketsReference =
      FirebaseFirestore.instance.collection('Tickets'.tr());
  CollectionReference walletsReference =
      FirebaseFirestore.instance.collection('Wallets'.tr());
  CollectionReference cardsReference =
      FirebaseFirestore.instance.collection('Cards'.tr());

  CollectionReference subscriptionsReference =
      FirebaseFirestore.instance.collection('Subscriptions'.tr());
  ...
  Future<void> signIn(
    ...
    try {
      ...
      await NotificationService.showNotification(
          title: 'Successfully Logged In'.tr(),
          body: email,
          payload: 'loggedin',
          context: context);
    } on auth.FirebaseAuthException catch (e) {
  ...
  Future<void> getUser(
    ...
    await usersReference.where('email'.tr(), isEqualTo: email).get().then((value) {
      value.docs.forEach((result) {
        myUser.User user = myUser.User(
            uid: result.id,
            email: result.get('email'.tr()),
            name: result.get('name'.tr()),
            phone: result.get('phone'.tr()),
            tagID: result.get('tagID'.tr()),
            nationalID: result.get('nationalID'.tr()));
  ...
  Future<void> checkUser(
    ...
    await usersReference
        .where('nationalID'.tr(), isEqualTo: nationalID)
        .get()
        .then((value) {
      value.docs.forEach((result) {
        myUser.User user = myUser.User(
  ...
  Future<void> checkWallet(
    ...
    await walletsReference.where('uid', isEqualTo: uid).get().then((value) {
      value.docs.forEach((result) {
        var balance = result.get('balance'.tr());
  ...
  Future<void> rechargeWallet(
    ...
    showSnackBar(context, "Wallet charged".tr());
  }
