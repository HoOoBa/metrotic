...
class _VerificationState extends State<Verification> {
  ...
  Widget build(BuildContext context) {
    ...
    context.read<AuthService>().verifyPhone(
        phone: routeArg['phone'].toString(),
        context: context,
        setData: setData);
              ...
              Column(children: <Widget>[
                      ...
                      Positioned(
                        child: Align(
                            ...
                            child: Container(
                              ...
                              margin:
                                  EdgeInsets.fromLTRB(15.8, 20.1, 16.4, 12.1),
                              child: SizedBox.expand(child: Icon(Icons.person)),
                            )),
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    context.read<AuthService>().signInWithPhoneNumber(
                        verificationIdFinal, code, context);
                  },
                  child: Container(
                      width: 120.0,
                      height: 50,
