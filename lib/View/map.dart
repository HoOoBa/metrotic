  ...
  _getCurrentLocation() async {
    await Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high)
      ...
      setState(() {
        ...
        print('CURRENT POS: $_currentPosition'.tr());
    ...
    try {
      ...
      Marker startMarker = Marker(
        ...
        infoWindow: InfoWindow(
          title: 'Start $startCoordinatesString'.tr(),
      ...
      Marker destinationMarker = Marker(
        ...
        infoWindow: InfoWindow(
          title: 'Destination $destinationCoordinatesString'.tr(),
      ...
      print(
        'START COORDINATES: ($startLatitude, $startLongitude)'.tr(),
      );
      print(
        'DESTINATION COORDINATES:. ($destinationLatitude, $destinationLongitude)'.tr(),
      );
      ...
      await  _createPolylines(startLatitude, startLongitude, destinationLatitude,
        ...
        print('DISTANCE: $_placeDistance km'.tr());
      });
